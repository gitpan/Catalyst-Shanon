...
<div class="bPageTitle">
  <div class="ptBody secondaryPalette">
    ...
    <div class="links">
      <!-- <a href="javascript:openPopupFocusEscapePounds('#', 'Help', 700, 600, 'width=700,height=600,resizable=yes,toolbar=no,status=no,scrollbars=yes,menubar=yes,directories=no,location=no,dependant=no', false, false);"><span  class="helpLink">このページのヘルプ</span><img src="/static/image/s.gif" alt="" class="helpImage"></a> -->
    </div>
  </div>
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr>
            ...
            <td class="pbButton"><input type="submit" value=" 編集 " class="btn" name="btn_edit"></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <tr>
    ...
    <td class="pbButton">
      <span id="search_display_on">
        <input type="button" value=" 詳細検索 " class="btn" name="btn_detail" onClick="javascript:showMoreLite('on'); set_search_type(this.form, 'detail');"></span>
      <span id="search_display_off" style="display:none">
        <input type="button" value=" 簡易検索 " class="btn" name="btn_simple" onClick="javascript:showMoreLite('off'); set_search_type(this.form, 'simple');"></span>
        <input type="submit" value=" 検索条件のクリア " class="btn" name="btn_crear"></td>
  </tr>
</tbody>
</table>
</div>
...
<tbody>
  <tr>
    <td align="center" class="pbButton">
      <input type="submit" value=" 検索開始 " class="btn" name="btn_search">&nbsp;
      <input type="submit" value=" CSVダウンロード " class="btn" name="btn_csvdownload"></td>
...
<div class="bPageFooter">
  <div class="body">
    <DIV><A href="#">サイトマップ</A> | <A href="#">プライバシーポリシー</A> | <A href="#">ログアウト</A></DIV>
  </div>
  <div class="footer">
    ...
    <tr>
      <td class="oLeft">
        ...
        <div class="mRecentItem">
          <div class="content">
            <div class="body">
              <a href="/seminar/logout" class="solution"><img src="/static/image/s.gif" alt="" class="mruIcon"><span class="mruText">全セミナー管理</span></a></div>
          </div>
        </div>
        <div class="mRecycle">
          <div class="content">
            <div class="body">
              <img src="/static/image/icon/sm_recycle.gif" width="26" height="19" align="absmiddle"><a href="/public/logout">システムログアウト</a></div>
          </div>
        </div>
        <div class="mRecentItem">
          <div class="content">
...
<div class="pbHeader">
  <table border="0" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        <td class="pbButton">
          　<input type="submit" value=" 新規登録 " class="btn" name="btn_new">
          <input type="submit" value=" 一括登録 " class="btn" name="btn_csvupload"></td>
        <td class="pbTitle"><img src="/static/image/s.gif" class="minWidth" height="1" width="1">
          <h3>$FORM{view_range}</h3></td>
        <td class="pbHelp">
          1頁の表示件数&nbsp;$FORM{page_list}&nbsp;<input type="submit" class="btn" value=" 変更 " name="btn_change"></td>
        <td class="pbHelp">
          頁移動&nbsp;$FORM{page_num}&nbsp;<input type="submit" class="btn" value= " 移動 " name="btn_go"></td>
      </tr>
    </tbody>
  </table>
</div>
...
__PACKAGE__->config( name => '[% app %]',
                     ...
                     email => [qw/SMTP mail.shanon.co.jp/],# Qmail localhost / 使える方でお願いします
                     ClassConfig => {
...
sub auto : Private {
    ...
    # btn_newが設定されてたらaddに飛ばす
    if ($c->req->param('btn_new')) {
        $c->redirect('add');
    # btn_editが設定されてたらaddに飛ばす
...
sub publish_before_parse_form_header{
    ...
    # 中メニュー
    $opt->{"menu2"} = 
      sprintf(qq!<li><a href="/%s/list">一覧</a></lit>\n!, 
        $c->action()->namespace()
      );
    $opt->{"menu2"} .= 
      sprintf(qq!<li><a href="/%s/add">新規追加</a></lit>\n!, 
        $c->action()->namespace()
      );
}
...
sub list_search {
    ...
    #-----------------------------------------------------
    # デフォルトでボタンを表示する
    $data{submit_search} = submit(-name=>"submit_search",-value=>'検索');
